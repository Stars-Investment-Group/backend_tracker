...
export class PriceHistoryController {
  ...
  @ApiOperation({
    ...
    description:
      "Ajoute ou met à jour le cours d'un instrument à un instant T (Admin/Analyste).",
  })
  @ApiResponse({
    status: 201,
    description: 'Cotation enregistrée avec succès.',
  })
  ...
  @ApiResponse({
    status: 201,
    description: 'Lot de cotations inséré avec succès.',
  })
  @ApiResponse({ status: 400, description: 'Données invalides.' })
  @ApiResponse({ status: 403, description: 'Accès refusé.' })
  ...
  @ApiOperation({
    ...
    description:
      'Retourne les cours historiques avec pagination et filtres de dates.',
  })
  @ApiParam({
    name: 'instrumentId',
    required: true,
  ...
  @ApiResponse({
    status: 200,
    description: 'Historique des cours retourné avec succès.',
  })
  @ApiResponse({ status: 404, description: 'Instrument introuvable.' })
  findByInstrument(
  ...
  @ApiOperation({
    ...
    description:
      'Retourne les cours historiques en recherchant par ticker (ex: AAPL, BRVM:SNTS).',
  })
  @ApiParam({
    name: 'ticker',
    required: true,
    description: "Le symbole boursier de l'instrument (ex: AAPL)",
  })
  @ApiResponse({
    status: 200,
    description: 'Historique des cours retourné avec succès.',
  ...
  @ApiOperation({
    ...
    description:
      'Retourne la cotation la plus récente pour la valorisation du portefeuille.',
  })
  @ApiParam({
    name: 'instrumentId',
    required: true,
  ...
  @ApiResponse({
    status: 404,
    description: 'Instrument ou cotation non trouvée.',
  })
  ...
  @ApiParam({
    name: 'id',
    required: true,
    description: "L'UUID de la cotation",
  })
